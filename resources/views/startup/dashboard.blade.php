    ...
    <style>
        * {
        ...
        .action-card:hover {
            ...
            transform: translateY(-4px);
            box-shadow: 0 12px 30px rgba(123, 29, 58, 0.15);
        }
        ...
        .action-icon.upload { background: linear-gradient(135deg, #818CF8, #6366F1); color: white; }
        .action-icon.issue { background: linear-gradient(135deg, #F87171, #EF4444); color: white; }
        .action-icon.moa { background: linear-gradient(135deg, #FBBF24, #F59E0B); color: white; }
        .action-icon.payment { background: linear-gradient(135deg, #34D399, #10B981); color: white; }
...
@php
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('startup.profile') }}" class="menu-item">
    ...
    <main class="main-content">
        ...
        <div class="quick-actions">
            ...
            <div class="actions-grid">
                <a href="{{ route('startup.upload-document') }}" class="action-card">
                    <div class="action-icon upload">
                        <i class="fas fa-cloud-upload-alt"></i>
                    </div>
                    <span class="action-title">Upload Document</span>
                    <span class="action-desc">Submit files & requirements</span>
                </a>
                <a href="{{ route('startup.report-issue') }}" class="action-card">
                    <div class="action-icon issue">
                        <i class="fas fa-exclamation-triangle"></i>
                    </div>
                    <span class="action-title">Report Room Issue</span>
                    <span class="action-desc">Report facility problems</span>
                </a>
                <a href="{{ route('startup.request-moa') }}" class="action-card">
                    <div class="action-icon moa">
                        <i class="fas fa-file-signature"></i>
                    </div>
                    <span class="action-title">Request MOA</span>
                    <span class="action-desc">Submit agreement request</span>
                </a>
                <a href="{{ route('startup.submit-payment') }}" class="action-card">
                    <div class="action-icon payment">
                        <i class="fas fa-credit-card"></i>
                    </div>
                    <span class="action-title">Submit Payment</span>
                    <span class="action-desc">Upload payment proof</span>
                </a>
            </div>
        </div>
